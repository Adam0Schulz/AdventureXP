...
public class InitialData implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Booking booking1 = new Booking(goKart, LocalDate.of(2022, 10, 6), LocalTime.of(15,0), LocalTime.of(17,0), 4, customer1);
        ...
        Booking booking4 = new Booking(miniGolf, LocalDate.of(2022, 10, 18), LocalTime.of(14,0), LocalTime.of(16,0), 3, customer2);
        Booking booking5 = new Booking(paintBall, LocalDate.of(2022, 10, 20), LocalTime.of(11,0), LocalTime.of(13,0), 6, customer3);
        Booking booking6 = new Booking(paintBall, LocalDate.of(2022, 10, 20), LocalTime.of(15,0), LocalTime.of(18,0), 8, customer1);
        Booking booking7 = new Booking(goKart, LocalDate.of(2022, 10, 8), LocalTime.of(15,0), LocalTime.of(17,0), 4, customer1);
        ...
        Booking booking10 = new Booking(miniGolf, LocalDate.of(2022, 10, 5), LocalTime.of(14,0), LocalTime.of(16,0), 3, customer2);
        Booking booking11 = new Booking(paintBall, LocalDate.of(2022, 10, 11), LocalTime.of(11,0), LocalTime.of(13,0), 6, customer3);
