...
public class InitialData implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Booking booking5 = new Booking(paintBall, LocalDate.of(2022, 10, 20), LocalTime.of(11,30), LocalTime.of(13,20), 6, customer3);
        ...
        Booking booking11 = new Booking(paintBall, LocalDate.of(2022, 10, 11), LocalTime.of(11,30), LocalTime.of(13,20), 6, customer3);
