...
public class InitialData implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        goKart.setInstructor(instructor1);
        sumoWrestling.setInstructor(instructor2);
        miniGolf.setInstructor(instructor3);
        paintBall.setInstructor(instructor4);
        beachVolleyball.setInstructor(instructor5);
        drivingRangeGolf.setInstructor(instructor6);
